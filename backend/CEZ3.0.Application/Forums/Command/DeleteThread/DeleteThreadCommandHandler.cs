...
public class DeleteThreadCommandHandler(ILogger<DeleteThreadCommandHandler> logger,
    IUserContext userContext,
    IThreadRepository threadRepository) : IRequestHandler<DeleteThreadCommand>
{
    private readonly ILogger<DeleteThreadCommandHandler> _logger = logger;
    ...
    {
        _logger.LogInformation("Handling DeleteThreadCommand for ThreadId: ");
